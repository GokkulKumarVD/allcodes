...
if proceed:
    ...
    try:
        ...
        ed_s_g['local_ranking'] = ed_s_g['score'].rank(ascending=False)
        ed_s_g['global_rank'] = ed_s_g['score'].rank(ascending=False)

        ed_s_g['csat_global_rank'] = ed_s_g['EFFORTSCORE'].rank(ascending=False)
        ed_s_g['frt_global_rank'] = ed_s_g['FRT'].rank(ascending=True)
        ed_s_g['aht_global_rank'] = ed_s_g['aht_secs'].rank(ascending=True)

        ed_s_g['csat_local_rank'] = ed_s_g['EFFORTSCORE'].rank(ascending=False)
        ed_s_g['frt_local_rank'] = ed_s_g['FRT'].rank(ascending=True)
        ed_s_g['aht_local_rank'] = ed_s_g['aht_secs'].rank(ascending=True)
        ...
        for i in q_list:
            ...
            agent_wise1['csat_global_rank'] = agent_wise1['EFFORTSCORE'].rank(ascending=False)
            agent_wise1['frt_global_rank'] = agent_wise1['FRT'].rank(ascending=True)
            agent_wise1['aht_global_rank'] = agent_wise1['aht_secs'].rank(ascending=True)

            # now finding local ranking
            agent_wise1['local_ranking'] = agent_wise1.groupby('Partners')['score'].rank(ascending=False)

            agent_wise1['csat_local_rank'] = agent_wise1.groupby('Partners')['EFFORTSCORE'].rank(ascending=False)
            agent_wise1['frt_local_rank'] = agent_wise1.groupby('Partners')['FRT'].rank(ascending=True)
            agent_wise1['aht_local_rank'] = agent_wise1.groupby('Partners')['aht_secs'].rank(ascending=True)
        ...
        live_global_leader['timestp'] = dt_string
        ...
        live_local_leader['timestp'] = dt_string
        ...
        data = [['Bau_food', 'aht', '200'], ['Bau_food', 'csat', '63'], ['Bau_food', 'frt', '10'],
        ...
        threshold_df['timestp'] = dt_string
