            ...
            <div class="col l4 ">
                <div class="card">
                    ...
                    <div class="card-content center">
                        ...
                        <?php
                        $sql = 'SELECT count(emp) as cnt FROM data;';
        ...
        <div class="card-content">
            <table class="highlight centered">
                ...
                <tbody>
                    ...
                    <?php
                    $sql = 'SELECT emp,currentpassword,newpassword FROM data;';
                    // $results = $dbo->query($sql);
                    ...
                    foreach ($results as $result) {
                        echo "<tr><td>$result[emp]</td><td>$result[currentpassword]</td><td>$result[newpassword]</td></tr>";
                    }
                    ?>
