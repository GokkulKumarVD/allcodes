...
if(isset($_POST["action"]))
{
	...
	//arbaz ahmed
	if($_POST['action'] == 'change_discount_percentage')
	{

		// echo $_POST['order_amount'];
		// $netTotal = $_POST['order_amount'];
		// $discount_rate = $_POST["discount_percentage"]/100;
		// echo $discount_rate;
		// $total_discount = $netTotal * $discount_rate;
		// echo $total_discount;
		// $netTotal -= $total_discount;
		// echo $netTotal;
		$object->query = "
		UPDATE order_table
		SET discount_percentage = '".$_POST["discount_percentage"]."'
		WHERE order_id = '".$_POST["order_id"]."' 
		";
		$object->execute();
