...
$(document).ready(function(){
    ...
    $(document).on('click', '.primary', function(){
        console.log("sdfsdfsdfsdfsdfsdfsddfsdfsdfsdfsdfsdfssddf");
        var discount_percentage = $("#dp").val();
        var order_id = $("#dp").data('order_id');
        var order_amount = $("#dp").data('order_amount');
        ...
        $.ajax({
            url:"order_action.php",
            method:"POST",
            data:{order_id:order_id, discount_percentage:discount_percentage, order_amount:order_amount, action:'change_discount_percentage'},
            success:function(data)
            {
