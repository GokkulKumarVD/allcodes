...
try:
    ...
    mycursor = mydb.cursor()
    if (mycursor):
        mycursor.execute("select resolutionid from ticketinfo union select resolutionid from freshtickets")
...
if proceed:
    ...
    try:
        raw_fetch = cs.execute("""WITH raw_data AS
                                                (
                                                  ...
                                                  LEFT JOIN
                                                            (
                                                               ...
                                                               WHERE i.dt >= cast(dateadd('DAY',-7, to_date(current_date-1)) AS VARCHAR)
                                                               GROUP BY 1,2,3
                                                            ) AS i
                                                  ...
                                                  LEFT JOIN secure_views.igcc_restaurant_recovery.food_issue_restaurant_recovery rr
                                                    ON r.issueid=rr.foodissueid
                                                        AND rr.dt >= cast(dateadd('DAY',-7, to_date(current_date-1)) AS VARCHAR)
                                                  WHERE r.dt = current_date-1
                                                )
                                                ...
                                                (
                                                   ...
                                                   WHERE dpo.dt >= cast(dateadd('DAY',-30, to_date(current_date-1)) AS VARCHAR)
                                                   GROUP BY 1
                                                )
                                                ...
                                                (
                                                   ...
                                                   FROM (
                                                           ...
                                                           WHERE dt >= cast(dateadd('DAY',-7, to_date(current_date-1)) AS VARCHAR)
                                                         ) oft
                                                   INNER JOIN (
                                                   ...
                                                   WHERE oft.dt >= cast(dateadd('DAY',-7, to_date(current_date-1)) AS VARCHAR)
                                                   GROUP BY 1
                                                )
    ...
    if (list_id_rep.__len__() > 1):
        ...
        try:
            ...
            igcc_rep.to_csv("C:\\Users\\vd.gokkulkumar\\Desktop\\projects\\marvex\\igcc_rep.csv")
...
try:
    ...
    # reading NAT account
    nat = pd.read_csv("C:\\Users\\vd.gokkulkumar\\Desktop\\projects\\marvex\\nat.csv")
    ...
    igcc1 = igcc[~(igcc['Status'] == 'Waiting for ending staus')]
    ...
    # adding language
    lang = pd.read_csv("C:\\Users\\vd.gokkulkumar\\Desktop\\projects\\marvex\\languages.csv")
    ...
    igcc.to_csv("C:\\Users\\vd.gokkulkumar\\Desktop\\projects\\marvex\\igcc_working.csv", index=False)
