...
if proceed:
    ...
    try:
        ...
        try:
            ...
            aht.to_csv("/var/lakshya/aht.csv")
    ...
    try:
        ...
        agent_wise.to_csv('/var/lakshya/checkthis.csv')
        ...
        agent_wise_output.to_csv("/var/lakshya/agent_wise.csv")
        ...
        live.to_csv("/var/lakshya/files/live/live.csv", index=False)
        ...
        live_global_leader.to_csv("/var/lakshya/files/live/live_global_leader.csv", index=False)
        ...
        live_local_leader.to_csv("/var/lakshya/files/live/live_local_leader.csv", index=False)
        ...
        threshold_df.to_csv('/var/lakshya/files/live/threshold.csv', index=False)
